...
export const STORE_MANAGER_CAPABILITIES:ManagerCapability[]=[
  ...
  {id:"inventory.inspect",label:"Inspect stock and availability",domain:"inventory",platforms:["zid","salla"],risk:"read_only",preview:false,readback:true,rollback:false,approval:"never",availability:"connected"},
  ...
  {id:"orders.inspect",label:"Inspect orders and fulfilment",domain:"orders",platforms:["zid","salla"],risk:"read_only",preview:false,readback:true,rollback:false,approval:"never",availability:"connected"},
  {id:"orders.reconcile",label:"Reconcile orders, payments, refunds and invoices",domain:"finance",platforms:["salla"],risk:"read_only",preview:true,readback:true,rollback:false,approval:"never",availability:"connected"},
  {id:"shipping.inspect",label:"Inspect shipments and delivery exceptions",domain:"shipping",platforms:["salla"],risk:"read_only",preview:false,readback:true,rollback:false,approval:"never",availability:"connected"},
