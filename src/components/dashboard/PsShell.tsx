...
.ps-root { font-family:'Nunito Sans',system-ui,-apple-system,sans-serif; font-size:14px; -webkit-font-smoothing:antialiased; }
.ps-root h1,.ps-root h2,.ps-root h3 { font-family:'Space Grotesk',system-ui,-apple-system,sans-serif; }
