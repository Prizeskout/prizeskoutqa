...
export function ProductHeroDemo({lang}:{lang:DemoLanguage}) {
  ...
  const panel=useMemo(()=>renderPanel(stage.id,lang,t,phase),[stage.id,lang,phase]);
...
function renderPanel(id:string,lang:DemoLanguage,t:(pair:[string,string])=>string,phase:number){
