...
const TABS = [
  ...
  { label: "Integration paths", to: "/docs/guides/integration-paths" as const },
...
export function DocsSubNav() {
  ...
  const isActive = (to: string) => {
    ...
    if (to === "/docs/guides/integration-paths") return path === "/docs/guides/integration-paths";
    if (to === "/docs/guides")
      return path.startsWith("/docs/guides") && path !== "/docs/guides/integration-paths";
    if (to === "/docs")
      return (
        path === "/docs" ||
  ...
  return (
    ...
    >
      <div style={{ display: "flex", gap: 4, maxWidth: 1600, margin: "0 auto", overflowX: "auto" }}>
        {TABS.map((t) => {
