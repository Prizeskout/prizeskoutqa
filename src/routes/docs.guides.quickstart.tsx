  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Quickstart | PrizeSkout" },
      {
        ...
        content: "From zero to your first price recommendation in 5 minutes.",
      },
    ],
  }),
    ...
    <MarketingShell>
      ...
      >
        <div style={{ maxWidth: 880, margin: "0 auto" }}>
          ...
          >
            From store connection to your first real price recommendation in under five minutes. No
            SDK required , every step works with cURL, any HTTP client, or the in-dashboard API
            Explorer.
          </p>
          ...
          <Step
            ...
            body={
              <>
                ...
                and click <strong>Connect a Store</strong>. Complete the three-step setup , store
                config, channel connect, and margin floors. At the end you'll receive a short access
                code (e.g.{" "}
                <code
                  style={{
                    fontFamily: FONT_MONO,
                ...
                ). Save it , it's your key to the dashboard on any device. No email or password
                needed.
              </>
            }
          >
            <Callout>
              The dashboard comes pre-loaded with a sample dataset so you can explore every feature
              before connecting real data. Everything labelled <strong>seed</strong> in the API is
              demo data , your live data appears once you complete steps 3-5 below.
            </Callout>
          </Step>
          ...
          >
            <Callout>
              Test-mode keys are safe to use in local scripts and CI. They read real data from your
              account but cannot trigger live pricing actions. Switch to a live key only when you're
              ready to push approved recommendations to your storefront.
            </Callout>
          </Step>
          ...
          >
            ...
            <div style={{ marginTop: 14, fontSize: 13, color: "#5A5A58", lineHeight: 1.55 }}>
              You'll get back a JSON array of competitor prices with the freshest scraped values. If
              your account is new, the response includes{" "}
              <code
                style={{
                  fontFamily: FONT_MONO,
                  fontSize: 12,
              ...
              , that means the engine returned demo data while your competitors are being scraped
              for the first time.
            </div>
          </Step>
          ...
          <Step
            ...
            body={
              <>
                ...
                in the dashboard, click <strong>Add competitor</strong>, and paste any product URL
                from Carrefour Qatar, Lulu Hypermarket, Amazon.ae, or Noon. PrizeSkout will scrape
                the price and add it to your tracked dataset within minutes.
              </>
            }
          >
            <Callout>
              ...
              . This tells the engine which price is yours versus competitors'. Without a self URL,
              recommendations default to the catalog price you push via{" "}
              <code
                style={{
                  fontFamily: FONT_MONO,
                  fontSize: 12,
          ...
          >
            ...
            <div style={{ marginTop: 14, fontSize: 13, color: "#5A5A58", lineHeight: 1.55 }}>
              ...
              shows exactly which pricing rules fired, which passed, and which were overridden , so
