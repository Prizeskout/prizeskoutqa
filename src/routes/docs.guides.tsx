...
const GUIDES: {
  ...
  to?:
    ...
    | "/docs/guides/integration-paths";
}[] = [
  {
    icon: Network,
    title: "Integration paths",
    desc: "Choose between direct API delivery, a managed connector, or a platform partnership. Includes responsibilities and a production checklist.",
    eta: "10 min read",
    to: "/docs/guides/integration-paths",
  },
  {
    icon: Zap,
    title: "Quickstart",
...
function GuidesPage() {
  ...
  if (location.pathname !== "/docs/guides") return <Outlet />;
  return (
    <MarketingShell>
      <DocsSubNav />
      <section
      ...
      >
        <div style={{ maxWidth: 980, margin: "0 auto" }}>
          ...
          >
            Conceptual walkthroughs to complement the endpoint reference. Start with the Quickstart,
            then dig into the topic you need.
          </p>
            ...
            {GUIDES.map((g) => {
              ...
              const cardInner = (
                <>
                  ...
                  <div
                    style={{ fontSize: 13, color: "#5A5A58", lineHeight: 1.55, marginBottom: 12 }}
                  >
                    {g.desc}
                  </div>
                  <div
