...
function DocsPage() {
  ...
  return (
    ...
    @media(max-width:700px){.site-shell{width:calc(100% - 28px)}.site-nav{height:64px}.docs-head>div{display:block;padding-top:12px}.docs-name{font-size:13px}.tabs{height:50px;overflow-x:auto}.tabs button{padding:0 11px;white-space:nowrap}.layout{display:block}.sidebar{display:none;position:static;height:auto;border:0;border-bottom:1px solid var(--line)}.sidebar.open{display:block}.main{padding:28px 18px 70px}.mobile-docnav{display:flex;align-items:center;gap:7px;margin-bottom:20px;border:1px solid var(--line);background:#fff;border-radius:5px;padding:8px 10px}.article h1{font-size:30px}.outcomes{grid-template-columns:1fr}.outcomes>div+div{border-left:0;border-top:1px solid var(--line)}.simple-table>div,.numbered-flow li{grid-template-columns:1fr}.next-step{align-items:flex-start;flex-direction:column}.checks{grid-template-columns:1fr}.field{grid-template-columns:1fr}.errors>div{grid-template-columns:42px 1fr}.errors span{grid-column:2}.footer-top{grid-template-columns:1fr;gap:35px}.footer-links{grid-template-columns:1fr 1fr}.footer-bottom{flex-direction:column;gap:8px}.article table{display:block;overflow-x:auto}}
  `}</style>
      <SiteHeader />
